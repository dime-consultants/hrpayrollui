  ...
  return (
    <div>
      <PageHeader
        ...
        actions={<Button as={Link} to="/loan-requests" variant="ghost">View uploads</Button>}
      />

      <Card className="p-0">
        <DataTable columns={columns} rows={batches} loading={loading} error={error} empty="No loan batches yet." />
      </Card>
    </div>
  )
}
