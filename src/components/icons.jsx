// Minimal inline SVG icon set (stroke-based, 20px default) to avoid emoji usage.
...
export const IconEyeOff = (p) => (
  <Svg {...p}>
    <path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 7 11 7a13.16 13.16 0 0 1-1.67 2.68M6.6 6.6C3.4 8.4 1 12 1 12s4 7 11 7a9.26 9.26 0 0 0 5.4-1.6" />
